#ifndef __INCLUDED_TRIANGLE_H // NEIN
...
/**
 * \brief Given a triangle with all corners on integer coordinates, countPoints()
 ...
 * an additional number of points has been found. 
 * @param tri Pointer to the triangle
 * @param callback A function pointer used as a callback function. The callback function should
